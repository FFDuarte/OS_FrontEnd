...
// ----------------------------------------------------------------------
const TABLE_HEAD = [
  { id: 'nome', label: 'Cliente', alignRight: false },
  ...
  { id: 'anp', label: 'Ano', alignRight: false },
  { id: 'peca', label: 'Peças', alignRight: false },
  { id: 'peca', label: 'Serviço', alignRight: false },
  { id: 'peca', label: 'Valor', alignRight: false },
